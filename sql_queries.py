...
user_id INT NOT NULL,level VARCHAR(10), song_id INT, artist_id INT, 
session_id INT, location VARCHAR(200), user_agent VARCHAR(200))""")

user_table_create = ("""
CREATE TABLE IF NOT EXISTS users 
(user_id INT PRIMARY KEY, first_name VARCHAR(20) NOT NULL, 
last_name VARCHAR(20) NOT NULL, gender VARCHAR(10), level VARCHAR(10))""")

song_table_create = ("""
CREATE TABLE IF NOT EXISTS songs 
(song_id VARCHAR(20) PRIMARY KEY, title VARCHAR(200), artist_id VARCHAR(20), 
...
(start_time time PRIMARY KEY, hour INT NOT NULL, day INT NOT NULL, 
